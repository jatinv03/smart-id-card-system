...
  Serial.println("LABEL,Date,Time,Name,UID");// make four columns (Date,Time,[Name:"user name"]line 48 & 52,[Number:"user number"]line 49 & 53)
...
   Serial.print(",");
   Serial.println(UID); //send the Number to excel
